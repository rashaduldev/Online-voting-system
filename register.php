...
<head>
    ...
    <title>Online Voting System-- Registation</title>
...
<body>
    ...
    <form action="#" class="body_form">
        ...
        <input id="address_input" type="text" name="address" placeholder="Address"><br><br>
       <center>
        <div id="imagepart">
            <label>Upload images:</label>
            <input type="file" name="photo" placeholder="Enter Email"><br><br>
        </div>
    </center>
    <center><br>
        <div id="role_part">
